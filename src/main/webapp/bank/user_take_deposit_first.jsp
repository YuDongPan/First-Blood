   ...
   swal({
	...
	<div class="content">
		...
		<div class="save_money" style="margin-top:50px;margin-left:320px;">
			<!-- edit form -->
			<form class="layui-form layui-form-pane" method="post" role="form" id="myForm" action="<%=basePath%>/bank/user_take_deposit_first.do?pageNow=1">
				...
				<div class="layui-form-item" style="margin-top:20px;">
					...
					<div class="layui-input-block">
					<input type="password" class="layui-input" style="width:40%" id="pay_password" placeholder="请输入支付密码" name="pay_password"  onblur="checkPassword()">
