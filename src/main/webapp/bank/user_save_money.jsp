...
<c:if test="${msg=='no' }">
	...
	<div class="content">
		...
		<div id="search" style="margin-left: 320px;">
			<form name="myForm" class="layui-form layui-form-pane" action="<%=basePath%>/bank/user_save_money.do" method="post">
				...
				<div class="layui-form-item">	
					...
					<div class="layui-input-block">
					<input type="text" class="layui-input" style="width:27.5%" name="money" id="money" placeholder="请输入存款金额"  onblur="checkMoney()"/> 
					</div>
