    ...
    <div class='login'>
        ...
        <div class='login_fields'>
            ...
            <div class='login_fields__password'>
                ...
                <input id="passWord" name="passWord" placeholder='密码' maxlength="16" type='text' autocomplete="off" />
                <div class='validation'>
                    <img alt="" src='img/tick.png' />
                </div>
            </div>
            ...
            <div class="login_fields__link">
                <a href="<%=basePath%>/user/register.html">没有账户?点此注册</a>
            </div>
            </form>
        </div>
